                    ...
                    <div class="blog_left_sidebar">
                        ...
                        <?php foreach($jobs as $job) : ?>
                            <div class="blog_details">
                                    <a class="btn btn-default pull-left" href="<?php echo base_url(); ?>posts/editpost/<?php echo $job['slug']; ?>">Edit</a>
                                    <a class="d-inline-block" href="<?php echo site_url('/projects/' .$job['slug']); ?>">
                                    ...
                                    <ul class="blog-info-link">
                                        ...
                                        <!-- delete btn -->
                                        <?php echo form_open('/posts/delete/'.$job['jid']);?>
                                            <input type="submit" class="btn btn-danger" value="delete">
                                        </form>

                                        <a class="btn btn-default" href="<?php echo base_url(); ?>posts/edit/<?php echo $job['slug']?>">Edit</a>
                                    </ul>
                            </div>
                        <?php endforeach; ?>
